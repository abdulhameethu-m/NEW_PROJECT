# Enterprise Codebase Audit - 2026-06-19
...
- Source files scanned: 789
- Frontend route declarations: 195
- Backend route mounts: 62
- Backend endpoint declarations: 672
- Mongoose model declarations found: 215
- Scheduled/queue triggers found: 9
- Full JSON graph: `docs/enterprise-codebase-dependency-graph-2026-06-19.json`
...
| backend/src/services/__tests__/campaign-escrow-domain.test.js |test |6664 |zero-static-inbound-needs-runtime-verification |
...
| backend/src/services/__tests__/campaign-domain.test.js |test |3851 |zero-static-inbound-needs-runtime-verification |
...
- `/api`: apiLimiter), pickupRoutes), analyticsRoutes)
...
- `GET /vendor`: backend/src/modules/campaign/routes.js, backend/src/routes/review.routes.js
- `GET /influencer`: backend/src/modules/campaign/routes.js, backend/src/modules/reel/routes.js
...
| file |category |size |
| --- |--- |--- |
| frontend/src/pages/VendorInfluencerPage.jsx |frontend-page |166680 |
| backend/src/modules/commission/service.js |backend-module |156549 |
...
| frontend/src/pages/AdminInfluencerCommercePage.jsx |frontend-page |119897 |
| backend/src/modules/influencerCommerce/service.js |backend-module |114967 |
...
| backend/src/services/checkout.service.js |backend-service |67548 |
...
| frontend/src/pages/CheckoutPage.jsx |frontend-page |58670 |
| backend/src/services/homepage-layout.service.js |backend-service |58035 |
| backend/src/modules/reel/service.js |backend-module |49565 |
...
| backend/src/services/campaign-escrow.service.js |backend-service |46496 |
...
| frontend/src/components/reel/ReelFeed.jsx |frontend-component |42278 |
...
| frontend/src/pages/InfluencersHubPage.jsx |frontend-page |40348 |
...
1. Confirm zero static inbound references in `docs/enterprise-codebase-dependency-graph-2026-06-19.json`.
...
- Generated dependency graph: `docs/enterprise-codebase-dependency-graph-2026-06-19.json`.
