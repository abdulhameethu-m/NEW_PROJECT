...
const pageMeta = {
  ...
  "/admin/commerce-intelligence/settings": {
    title: "Recommendation Settings",
    subtitle: "Configure independent recommendation engines, weights, thresholds, and safeguards.",
  },
  "/admin/commerce-intelligence/related-products": {
    title: "Related Products Engine",
    subtitle: "Tune similarity scoring, matching rules, and product-to-product discovery quality.",
  },
  "/admin/commerce-intelligence/frequently-bought-together": {
    title: "Frequently Bought Together",
    subtitle: "Inspect bundle strength, co-purchase patterns, and add-on bundle behavior.",
  },
  "/admin/commerce-intelligence/cross-sell": {
    title: "Cross Sell Rules",
    subtitle: "Control cart and checkout add-ons without changing core cart or order logic.",
  },
  "/admin/commerce-intelligence/upsell": {
    title: "Upsell Rules",
    subtitle: "Promote premium alternatives using inventory-aware price upgrade windows.",
  },
  "/admin/commerce-intelligence/analytics": {
    title: "Recommendation Analytics",
    subtitle: "Track views, clicks, CTR, conversion, and revenue generated by recommendation surfaces.",
  },
  "/admin/commerce-intelligence/ai-scoring": {
    title: "AI Scoring Rules",
    subtitle: "Manage rule-driven recommendation weighting and configurable scoring strategies.",
  },
  "/admin/commerce-intelligence/preview": {
    title: "Recommendation Preview",
    subtitle: "Preview product-level recommendation outputs and score breakdowns before publishing.",
  },
  "/admin/commerce-intelligence/cache": {
    title: "Cache Management",
    subtitle: "Refresh or clear precomputed recommendation caches without affecting storefront stability.",
  },
  "/admin/revenue": {
    title: "Revenue",
