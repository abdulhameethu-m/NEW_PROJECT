    ...
    <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="mt-4 space-y-3 text-sm text-slate-600 dark:text-slate-300">
        ...
        <div className="flex items-center justify-between">
          <span>MRP ({breakdown.itemCount || 1} {breakdown.itemCount === 1 ? "item" : "items"})</span>
          <span className="font-medium text-slate-950 dark:text-white">{formatCurrency(breakdown.mrp || 0)}</span>
        </div>
        ...
        {breakdown.handlingFee > 0 && (
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium text-slate-950 dark:text-white">
              + {formatCurrency(breakdown.handlingFee)}
            </span>
          </div>
        )}
      ...
      {/* Free Delivery Info */}
      {breakdown.deliveryFee === 0 && breakdown.mrp > 0 && (
