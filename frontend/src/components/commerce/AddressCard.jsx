  ...
  return (
    <div
      className={`rounded-[1.75rem] border p-5 shadow-sm transition ${
        selected
          ? "border-indigo-600 bg-indigo-50/50 shadow-sm dark:bg-indigo-900/20"
          ...
          {onSelect ? (
            <button
              ...
              className={`rounded-xl px-4 py-2 text-sm font-semibold text-white shadow-sm ${
                selected ? "bg-slate-900 dark:bg-slate-100 dark:text-slate-900" : "bg-indigo-600 hover:bg-indigo-700"
              }`}
            >
