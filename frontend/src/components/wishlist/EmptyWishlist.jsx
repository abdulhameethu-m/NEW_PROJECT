  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-3 py-8">
      <div className="rounded-lg border border-slate-200 bg-white p-6 text-center dark:border-slate-700 dark:bg-slate-900">
        ...
        <h3 className="text-base font-semibold text-slate-900 dark:text-slate-100">Your wishlist is empty</h3>
        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Save products you love and view them here later.</p>
        <div className="mt-4">
