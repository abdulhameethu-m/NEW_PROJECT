...
export function SearchBar({ className = "" }) {
  ...
  return (
    <div ref={searchRef} className={`group relative mx-auto w-full max-w-4xl ${className}`.trim()}>
      ...
      {showResults && (
        <div className="absolute left-0 right-0 top-full z-50 mt-2 max-h-[28rem] overflow-y-auto rounded-[1.75rem] border border-slate-200/80 bg-white/95 p-2 shadow-[0_35px_100px_-45px_rgba(15,23,42,0.5)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/95">
          {loading && (
