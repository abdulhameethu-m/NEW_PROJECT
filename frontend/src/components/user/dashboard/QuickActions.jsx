  ...
  return (
    <section aria-label="Quick actions" className="grid grid-cols-4 gap-2">
      {actions.map((action) => (
        ...
        >
          <span className="flex h-9 w-9 items-center justify-center rounded-2xl bg-slate-100 text-slate-800 transition group-hover:bg-slate-950 group-hover:text-white dark:bg-slate-800 dark:text-slate-100 dark:group-hover:bg-white dark:group-hover:text-slate-950">
