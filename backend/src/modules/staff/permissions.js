const STAFF_PERMISSION_CATALOG = Object.freeze({
  ...
  reviews: ["read", "delete"],
  analytics: ["read"],
  revenue: ["read", "create", "update", "delete"],
  auditLogs: ["read", "create", "update", "delete"],
  sellers: ["read", "create", "update", "delete"],
  inventory: ["read", "create", "update", "delete"],
  pickups: ["read", "create", "update", "delete"],
  ...
  vendorAccess: ["read", "create", "update", "delete"],
  shippingAccess: ["read", "create", "update", "delete"],
  ...
  refunds: ["read", "create", "update", "delete"],
  returns: ["read", "create", "update", "delete"],
  escrowRefunds: ["read", "create", "update", "delete"],
  ...
  financeInfluencers: ["read", "create", "update", "delete"],
