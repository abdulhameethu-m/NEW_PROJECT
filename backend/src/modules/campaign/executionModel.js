...
const deliverableSubmissionSchema = new mongoose.Schema(
  {
    ...
    contentTitle: { type: String, trim: true, maxlength: 180, default: "" },
    contentDescription: { type: String, trim: true, maxlength: 2000, default: "" },
    contentCaption: { type: String, trim: true, maxlength: 1000, default: "" },
