...
const uploadMedia = asyncHandler(async (req, res) => {
  ...
  return ok(res, {
    ...
    imageUrls: thumbnails.map((file) => `/uploads/reels/${file.filename}`),
    documentUrl: document ? `/uploads/reels/${document.filename}` : "",
...
module.exports = { upload, uploadMedia, publish, feed, getById, engagement, like, save, comments, comment, reply, commentLike, commentReport, share, view, storeVisit, productClick, follow, adjacent, contentList, contentUpdate, contentDelete, mediaLibrary, adminList };
