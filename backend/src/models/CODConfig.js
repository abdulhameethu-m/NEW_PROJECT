...
const codConfigSchema = new mongoose.Schema(
  {
    ...
    advance: {
      ...
      defaultAdvanceType: { type: String, enum: ["FIXED", "PERCENTAGE"], default: "FIXED" },
      defaultAdvanceValue: { type: Number, min: 0, default: 0 },
      minAdvanceAmount: { type: Number, min: 0, default: 0 },
      maxAdvanceAmount: { type: Number, min: 0, default: 0 },
      includeShippingInBasis: { type: Boolean, default: true },
      requireBeforeOrderCreation: { type: Boolean, default: true },
    },
    cancellationCharges: {
      isEnabled: { type: Boolean, default: false },
      onlineEnabled: { type: Boolean, default: false },
      codRefundEnabled: { type: Boolean, default: true },
      autoRefundEnabled: { type: Boolean, default: false },
      manualRefundEnabled: { type: Boolean, default: true },
      type: { type: String, enum: ["FIXED", "PERCENTAGE"], default: "FIXED" },
      amount: { type: Number, min: 0, default: 0 },
      applicableBeforeShipment: { type: Boolean, default: true },
      applicableAfterShipment: { type: Boolean, default: false },
      minimumDeduction: { type: Number, min: 0, default: 0 },
      maximumDeduction: { type: Number, min: 0, default: 0 },
    },
