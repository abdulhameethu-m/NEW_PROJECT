...
const REVIEWED_NON_IDOR_CONTEXTS = [
  ...
  {
    pattern: /[\\/]services[\\/](campaign-fee|cancellation-policy|finance-config|guestWishlist|homepage-layout|influencer-commerce-config|platform-bootstrap|pricing-category|product-number|settlement-metrics|shipping-config|shipping-zone-config|shippingConfigAdmin)\.service\.js$/,
